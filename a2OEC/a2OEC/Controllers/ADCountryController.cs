...
namespace a2OEC.Controllers
{
    public class ADCountryController : Controller
    {
        ...
        public ADCountryController(OECContext context)
        {
            _context = context;
        }
        ...
        // GET: ADCountry/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ADCountry/Create
